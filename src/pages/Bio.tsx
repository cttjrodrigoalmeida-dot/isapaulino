      ...
      <div className={styles.bioContainer}>
        ...
        <main className={styles.content}>
          ...
          <div className={styles.section}>
            ...
            <a href="https://www.instagram.com/isapaulinostudio" target="_blank" rel="noopener noreferrer" className={`btn btn-outline ${styles.linkBtn} ${styles.br2}`}>
              INSTAGRAM
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" width="14" height="14">
                <path d="M5 12h14M12 5l7 7-7 7" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
          ...
          <div className={styles.footerInfo}>
            ...
            <div className={styles.socialIconsRow}>
              ...
              <a href="mailto:isapaulinostudio@gmail.com" target="_blank" rel="noopener noreferrer" aria-label="E-mail">
