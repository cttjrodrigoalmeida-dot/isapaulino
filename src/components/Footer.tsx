        ...
        <div className="container">
          <div className={styles.footerGrid}>
              ...
              <div className={styles.servicesAndContact}>
                ...
                <ul className={styles.contactList}>
                  ...
                  <li>
                    ...
                    <a href="mailto:isapaulinostudio@gmail.com" className={styles.contactValue}>isapaulinostudio@gmail.com</a>
                  </li>
                  <li>
                    <span className={styles.contactIcon}>
                      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" width="16" height="16">
            ...
            <div className={styles.socialCol}>
              ...
              <a href="https://www.tiktok.com/@isapaulinostudio" target="_blank" rel="noopener noreferrer" className={styles.socialLink} aria-label="TikTok">
              ...
              <a href="https://www.threads.com/@isapaulinostudio" target="_blank" rel="noopener noreferrer" className={styles.socialLink} aria-label="Threads">
                <svg viewBox="0 0 24 24" fill="currentColor" width="16" height="16">
